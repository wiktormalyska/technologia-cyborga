...
const colorPalette: { [key in 'primary' | 'secondary' | 'accent' | 'text' | 'secondaryText' | 'pageBackground' | 'inputBackground' | 'buttonBackground' | 'border' | 'highlight']: Color } = {
    ...
    pageBackground: { hex: "#313142" }, // Tło dla strony
